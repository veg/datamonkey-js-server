...
ExecuteAFile (baseFilePath + ".codonFit");
sim_fit_file = baseFilePath + ".sim.codonFit";
sim_grid_info = baseFilePath + ".sim.grid_info";
...
d1 = 0; d2 = 0;
posteriorsUnderNN = reportSiteResults (nn_sample_count, 0, "d1", "d2", 1);
