...
GLOBAL_FPRINTF_REDIRECT = csvFilePath + ".progress";
...
newjsonFilePath = csvFilePath + ".new.json";
taskTimerStop (4);
(_BSREL_json ["timers"])["overall"] = _BSREL_timers[4];
fprintf        (jsonFilePath, CLEAR_FILE, _BSREL_json);
_BSREL_json = utility.associativeListToJSON(_BSREL_json);
fprintf        (newjsonFilePath, CLEAR_FILE, _BSREL_json);
