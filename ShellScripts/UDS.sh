...
# OpenMPI
(echo $1; echo $2; echo $3; echo $4; echo $5; echo $6; echo $7; echo $8; echo $9; echo ${10}; echo ${11}; echo ${12}; echo ${13}; echo ${14};) | mpirun -np 101 -hostfile $HOSTFILE /usr/local/bin/HYPHYOPENMPI  USEPATH=/dev/null USEPATH=$ABS_DIR/Analyses/UDS/ $ABS_DIR/Analyses/UDS/454_launcher_codon.bf > $ABS_DIR/Analyses/UDS/hpout 2>&1 &
