...
(echo $1; echo $2; echo $3; echo $4; echo $5; echo $6) | mpirun -np 61 /usr/local/bin/HYPHYMPI  USEPATH=/dev/null /home/datamonkey/Datamonkey/Analyses/GARD/GARD.bf  > Analyses/GARD/hpout 2>&1 &
