...
# Open MPI
(echo $1; echo $2; echo $3) | mpirun -np 51 -nolocal -hostlist $HOSTLIST /usr/local/bin/HYPHYOPENMPI USEPATH=$ABS_DIR/Analyses/BGM/ $ABS_DIR/Analyses/BGM/BGM2.bf > $ABS_DIR/Analyses/BGM/hpout 2>&1 &
