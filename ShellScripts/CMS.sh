...
# OpenMPI
(echo $1; echo $2; echo $3; echo $4; echo $5; echo $6; echo $7; echo $8; echo $9; echo ${10}; ) | mpirun -np 33 -hostfile $HOSTFILE /usr/local/bin/HYPHYOPENMPI USEPATH=$ABS_DIR/Analyses/CMS/ $ABS_DIR/Analyses/CMS/ModelSelectorCodon.bf > $ABS_DIR/Analyses/CMS/hpout 2>&1 & 
