...
(echo $1; echo $2; echo $3; echo $4; echo $5;) | mpirun -np 97 /usr/local/bin/HYPHYMPI USEPATH=/home/datamonkey/Datamonkey/Analyses/MEME/ /home/datamonkey/Datamonkey/Analyses/MEME/MEME_new.bf > Analyses/MEME/hpout 2>&1 
