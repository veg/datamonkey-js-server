...
#OpenMPI
(echo $1; echo $2; echo $3; echo $4; echo $5; echo $6; echo $7;) | mpirun -np 33 -hostfile $HOSTFILE /usr/local/bin/HYPHYOPENMPI USEPATH=$ABS_DIR/Analyses/DEPS/ $ABS_DIR/Analyses/DEPS/DEPS.bf > $ABS_DIR/Analyses/DEPS/hpout 2>&1 &
