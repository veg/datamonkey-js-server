...
#OpenMPI
(echo $1; echo $2; echo $3; echo $4; echo $5;) | mpirun -np 10 -hostfile $HOSTFILE /usr/local/bin/HYPHYOPENMPI USEPATH=$ABS_DIR/Analyses/PARRIS/ $ABS_DIR/Analyses/PARRIS/PARRIS.bf > $ABS_DIR/Analyses/PARRIS/hpout 2>&1 &
