...
#OpenMPI
(echo $1; echo $2; echo $3; echo $4; echo $5; ) | mpirun -np 33 -hostfile $HOSTFILE /usr/local/bin/HYPHYMPI USEPATH=$ABS_DIR/Analyses/EVF/ $ABS_DIR/Analyses/EVF/EVF.bf > $ABS_DIR/Analyses/EVF/hpout 2>&1 & 
