...
# OpenMPI
(echo $1; echo $2; echo $3; echo $4) | mpirun -np 33 -hostfile $HOSTFILE /usr/local/bin/HYPHYMPI USEPATH=/dev/null  $ABS_DIR/Analyses/GABranch/GABranch.bf >  $ABS_DIR/Analyses/GABranch/hpout 2>&1 &
