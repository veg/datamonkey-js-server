...
# OpenMPI
(echo $1; echo $2; echo $3; echo $4;) | mpirun -np 41 -hostfile $HOSTFILE /usr/local/bin/HYPHYOPENMPI  USEPATH=/dev/null USEPATH=$ABS_DIR/Analyses/Toggle/ $ABS_DIR/Analyses/Toggle/FELtoggle.bf > $ABS_DIR/Analyses/Toggle/hpout 2>&1 & 
