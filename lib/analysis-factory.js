...
function buildExport(self, descriptor) {
  ...
  // Most analyses emit a treemode key here; a few (e.g. prime) omit it. The
  // descriptor opts out via omitTreemode so the prefix stays byte-identical.
  if (!descriptor.omitTreemode) {
    pairs.push("treemode=" + self.treemode);
  }
